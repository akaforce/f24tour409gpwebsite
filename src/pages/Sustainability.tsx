  ...
  return (
    <div className='bg-red-700 h-full flex flex-col'>
      ...
      <div className='bg-red-700 relative'>
        ...
        />
        <h1 className="absolute top-[15%] left-[50%] transform -translate-x-1/2 text-center text-5xl md:text-6xl lg:text-7xl text-white font-bold">Sustainability</h1>
        <h2 className="absolute top-[40%] left-[50%] transform -translate-x-1/2 text-center text-2xl md:te3t-4xl lg:text-5xl text-yellow-400 font-bold">Why is sustainability important to us? Why is travelling sustainably important?</h2>
      </div>
      ...
      <div className='m-5 p-16 bg-black'>
        ...
        <div className='mt-5 grid grid-cols-1 md:grid-cols-4 gap-5'>
          ...
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-3xl font-semibold text-yellow-400'>Eco-Friendly Practices</h2>
          ...
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-3xl font-semibold text-yellow-400'>Sustainable Transportation</h2>
            <p className='text-center text-2xl text-gray-200 mt-2'>
          ...
          {/* Local Empowerment */}
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-3xl font-semibold text-yellow-400'>Local Empowerment</h2>
            <p className='text-center text-2xl text-gray-200 mt-2'>
          ...
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-3xl font-semibold text-yellow-400'>Carbon Offset Programs</h2>
            <p className='text-center text-2xl text-gray-200 mt-2'>
      ...
      <div className='p-10 bg-black'>
        <h1 className='items-center text-center text-4xl inset-x-0 bottom-0 text-red-500'>
