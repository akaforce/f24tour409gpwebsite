  ...
  return (
    <div className='bg-red-700 h-full flex flex-col'>
      ...
      <div className='bg-red-700 relative'>
        ...
        <h2 className="absolute top-[40%] left-[50%] transform -translate-x-1/2 text-center text-2xl md:text-4xl lg:text-5xl text-yellow-400 font-bold">Why is sustainability important to us? Why is travelling sustainably important?</h2>
      </div>
