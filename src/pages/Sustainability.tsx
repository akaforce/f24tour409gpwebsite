      ...
      <div className='m-5 p-16 bg-black'>
        ...
        <div className='mt-5 grid grid-cols-1 md:grid-cols-4 gap-5'>
          ...
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-2xl font-semibold text-yellow-400'>Eco-Friendly Practices</h2>
          ...
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-2xl font-semibold text-yellow-400'>Sustainable Transportation</h2>
            <p className='text-center text-2xl text-gray-200 mt-2'>
          ...
          {/* Local Empowerment */}
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-2xl font-semibold text-yellow-400'>Local Empowerment</h2>
            <p className='text-center text-2xl text-gray-200 mt-2'>
          ...
          <div className='p-5 bg-red-900 rounded-lg'>
            <h2 className='text-center text-2xl font-semibold text-yellow-400'>Carbon Offset Programs</h2>
            <p className='text-center text-2xl text-gray-200 mt-2'>
