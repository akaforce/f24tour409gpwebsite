  ...
  return (
    <div className='bg-black h-fit flex flex-col'>
      ...
      <div className='relative'>
        ...
        <h2 className="absolute top-[40%] left-[50%] transform -translate-x-1/2 text-center text-base md:text-3xl lg:text-3xl text-yellow-400 font-bold">The FIFA games span a month, and this itinerary showcases a sample weekend for tourists. 
        ...
        <h1 className='text-center text-3xl text-yellow-400 font-bold'>Day 1: Friday - Immersive Football Kickoff</h1>

        {/* Morning */}
        <h2 className='text-left text-5xl text-white font-bold mt-10'>Morning</h2>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mt-5'>
          <div className='p-5 bg-black rounded-lg'>
            <ul className='text-3xl text-gray-200 list-disc pl-5'>
      ...
      <div className='mx-5 mt-10 mb-5 p-5 bg-black'>
        <h1 className='text-center text-3xl text-yellow-400 font-bold'>Day 2: Saturday - The Big Game Experience</h1>
      ...
      {/* Day 3 Section */}
      <div className='mx-5 mt-10 mb-5 p-5 bg-red-800'>
        <h1 className='text-center text-3xl text-yellow-400 font-bold'>Day 3: Sunday - Explore Istanbul</h1>
