  ...
  return (
    <div className='bg-black h-screen flex flex-col'>
        ...
        <div className='bg-red-700 relative'>
            ...
            />
            <h1 className='absolute top-[175px] left-[30%] text-center text-9xl text-white font-bold'>Contact Us</h1>
        ...
        <div className='m-5 p-10 bg-red-800'>
            <h1 className='text-center text-7xl font-bold text-white'>Contact Information</h1>
            <div className='mt-5 grid grid-cols-1 md:grid-cols-2 gap-5'>
                <div className='p-5'>
                    <h2 className='text-4xl font-semibold text-white'>Reach Us</h2>
                ...
                <div className='p-5'>
                    <h2 className='text-4xl font-semibold text-white'>Follow Us</h2>
        ...
        <div className='m-5 p-10 bg-black'>
            <h1 className='text-center text-7xl font-bold text-red-500'>Meet the Team</h1>
